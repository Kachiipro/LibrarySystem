...
SECRET_KEY = 'django-insecure-y$=msllt05hda2cj5$9g#e!c+9n1_fcw!-#fnppbv+pbo7bdp5'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'anon': '100/minute',  # Unauthenticated users: 100 requests per minute
    }
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [
        'books.throttling.CustomRateThrottle',  # Ensure this matches your project
    ],

    'DEFAULT_THROTTLE_RATES': {
        'custom': '100/minute',  # Set a rate limit (100 requests per minute)
    }
}
